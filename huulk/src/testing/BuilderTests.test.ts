...
import { CSRF_HEADER, HuulkHttpMethods, HuulkOptions, NodeRequest, NodeResponse, ONE_DAY_IN_MS, CacheManagerImplementation, UserObjectSessionDataTypeBase } from "../HuulkTypes";
import { HuulkConfigurerFacade } from "./HuulkBuilder";
import { mockEmptyNodeRequest, mockEmptyNodeResponse } from "./TestSetup.js";

//@ts-ignore
let testOptions: HuulkOptions = new HuulkConfigurerFacade()
.startConfiguration()
...
let corsManager: HuulkCorsRegistry;
let mockedRequest:NodeRequest<UserObjectSessionDataTypeBase>;
let mockedResponse: NodeResponse = mockEmptyNodeResponse();
