...
import {  createLoginSession, deleteLoginSession, Huulk} from "./Huulk.js";
//@ts-ignore
import parser from "cookie-parser";
import {CSRF_HEADER,HuulkHttpMethods,HuulkOptions, ONE_DAY_IN_MS, CacheManagerImplementation, UserObjectSessionDataTypeBase, HuulkSession, NodeRequest} from "./index.js"
import { createClient, RedisClientOptions } from "redis";
import { HuulkConfigurerFacade } from "./testing/HuulkBuilder.js";

function startExpress(){

let TEST_TERM : any = undefined;    
...
let options:HuulkOptions = new HuulkConfigurerFacade()
            .startConfiguration()
                ...
                .buildCors(
                    ...
                    [HuulkHttpMethods.DELETE,HuulkHttpMethods.POST,HuulkHttpMethods.OPTIONS],
                    true
                    )
...
let huulk: Huulk = new Huulk(options);            
...
//@ts-ignore
app.post("/auth/sessionUpdate",async (req: NodeRequest<UserObjectSessionDataTypeBase>,res) => {
    let session: HuulkSession<UserObjectSessionDataTypeBase> = req.huulkSession;
    let testSet: any = [0,1]
...
let myset = new Map<number,number>();
    let dict: any = {}
    dict["hi"] = "hello" 
